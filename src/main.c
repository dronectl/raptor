...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOB, LED_GREEN_Pin | ESTOP_RELAY_Pin | AUX_PWR_RELAY_Pin | LED_RED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, BATT_CHARGE_Pin | BATT_PWR_RELAY_Pin | LED_YELLOW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_GREEN_Pin ESTOP_RELAY_Pin AUX_PWR_RELAY_Pin LED_RED_Pin */
  GPIO_InitStruct.Pin = LED_GREEN_Pin | ESTOP_RELAY_Pin | AUX_PWR_RELAY_Pin | LED_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : BATT_CHARGE_Pin BATT_PWR_RELAY_Pin LED_YELLOW_Pin */
  GPIO_InitStruct.Pin = BATT_CHARGE_Pin | BATT_PWR_RELAY_Pin | LED_YELLOW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
