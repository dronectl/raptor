...
#define ADC_AUX2_THERM_Pin GPIO_PIN_9
#define ADC_AUX2_THERM_GPIO_Port GPIOF
#define ADC_BLDC_VSENSE_Pin GPIO_PIN_10
#define ADC_BLDC_VSENSE_GPIO_Port GPIOF
#define MCO_Pin GPIO_PIN_0
#define MCO_GPIO_Port GPIOH
#define ADC_BATT_THERM_Pin GPIO_PIN_0
#define ADC_BATT_THERM_GPIO_Port GPIOC
#define RMII_MDC_Pin GPIO_PIN_1
#define RMII_MDC_GPIO_Port GPIOC
#define ADC_BLDC_ISENSE_N_Pin GPIO_PIN_2
#define ADC_BLDC_ISENSE_N_GPIO_Port GPIOC
#define ADC_BLDC_ISENSE_P_Pin GPIO_PIN_3
#define ADC_BLDC_ISENSE_P_GPIO_Port GPIOC
#define ADC_AUX1_THERM_Pin GPIO_PIN_0
#define ADC_AUX1_THERM_GPIO_Port GPIOA
...
#define ADC_BLDC_THERM_Pin GPIO_PIN_6
#define ADC_BLDC_THERM_GPIO_Port GPIOA
...
#define ADC_ESC_THERM_Pin GPIO_PIN_1
#define ADC_ESC_THERM_GPIO_Port GPIOB
