...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PF12     ------> ADC1_INN2
    */
    GPIO_InitStruct.Pin = ADC_BATT_THERM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_BATT_THERM_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_AUX1_THERM_Pin|ADC_LC1_P_Pin|ADC_LC1_N_Pin|ADC_BLDC_THERM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_ESC_THERM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_ESC_THERM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    GPIO_InitStruct.Pin = ADC_AUX2_THERM_Pin|ADC_BLDC_VSENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF12     ------> ADC1_INN2
    */
    HAL_GPIO_DeInit(ADC_BATT_THERM_GPIO_Port, ADC_BATT_THERM_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_AUX1_THERM_Pin|ADC_LC1_P_Pin|ADC_LC1_N_Pin|ADC_BLDC_THERM_Pin);

    HAL_GPIO_DeInit(ADC_ESC_THERM_GPIO_Port, ADC_ESC_THERM_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(GPIOF, ADC_AUX2_THERM_Pin|ADC_BLDC_VSENSE_Pin);
